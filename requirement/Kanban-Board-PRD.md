...
| [11](#11-board-list-view) | Board "List View" | Implemented (#45–#48) |
...
**สถานะ:** Implemented — 4 vertical slices: [#45](https://github.com/khthana/kanban-board/issues/45) (read-only List view), [#46](https://github.com/khthana/kanban-board/issues/46) (sticky headers + Column Accent theming), [#47](https://github.com/khthana/kanban-board/issues/47) (row → Card panel wiring), [#48](https://github.com/khthana/kanban-board/issues/48) (add card from section foot)
